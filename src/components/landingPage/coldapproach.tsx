...
import { Send, Target, Users, Zap, ArrowRight } from "lucide-react"
    ...
    const features = [
        {
            ...
            description: "Craft tailored messages that resonate with each recipient.",
        },
        {
            icon: <Users className="h-8 w-8 text-blue-500" />,
            title: "Network Expansion",
            description: "Grow your professional network strategically and effectively.",
        },
        {
            icon: <Zap className="h-8 w-8 text-yellow-500" />,
            title: "Follow-up Strategies",
            description: "Optimize your follow-up timing and content for maximum impact.",
        },
    ]
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    >
                        <div className="relative">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-green-500/20 mix-blend-overlay rounded-lg"></div>
                            <motion.div
                    ...
                    >
                        ...
                        <motion.p className="text-xl text-gray-600 dark:text-gray-300 mb-10" variants={itemVariants}>
                            Stand out in the job market with our AI-powered cold approach assistant. Craft personalized outreach
                            messages and expand your professional network effectively.
                        </motion.p>
