...
const AnalyzingResumeAnimation = () => {
            ...
            >
                <div className="relative w-[400px] h-[400px]">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                        ...
                        <motion.div
                            className="mt-6 text-2xl font-bold text-white text-center"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        <motion.div
                            className="mt-2 text-sm text-purple-200 text-center"
                            initial={{ opacity: 0, y: 10 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.7, duration: 0.5 }}
                        >
                            Harnessing AI to process your resume
                        </motion.div>
...
export default AnalyzingResumeAnimation;
