...
export default function HCSInterviewAssistant() {
    ...
    useEffect(() => {
        hcsWsRef.current = new HCSWebSocket("wss://ws3.nextround.tech/hcs")
    ...
    const endInterview = () => {
        console.log("Ending interview and showing completion modal")
        if (hcsWsRef.current) {
            hcsWsRef.current.endInterview()
        }
        // Force the interview complete state to true
        setInterviewComplete(true)
        setIsRecording(false)
    }
