...
import { GeoWebSocket } from "@/lib/upsc/subject/geo-ws"
...
export default function GeographyInterview() {
  ...
  useEffect(() => {
    const ws = new GeoWebSocket("wss://ws3.nextround.tech/upsc-geography")
    geoWsRef.current = ws
  ...
  const toggleMicrophone = () => {
    if (!geoWsRef.current || !interviewState.isRecording) return
    ...
    return (
      ...
      >
        <main className="flex-1 flex items-center justify-center p-4 md:p-6">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-500">
            ...
            >
              {responses.length > 0 ? (
                ...
                <p className="text-gray-400 italic text-sm md:text-base">
                  Waiting for the geography interview to begin...
                </p>
              )}
            </motion.div>
          </motion.div>
                ...
                {uiState.showChat && (
                  <div className="space-y-4">
                    {responses.map((response, index) => (
                      ...
                      >
                        <p
                          className={`text-sm font-medium mb-1 ${index % 2 === 0 ? "text-blue-300" : "text-cyan-300"}`}
                        >
                ...
                {uiState.showParticipants && (
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      <div>
                        <p className="font-medium text-blue-300">Geography Interviewer</p>
