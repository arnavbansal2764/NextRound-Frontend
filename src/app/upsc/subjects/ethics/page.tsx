...
import { EthicsWebSocket } from "@/lib/upsc/subject/ethics-ws"
...
export default function EthicsInterview() {
  ...
  useEffect(() => {
    const ws = new EthicsWebSocket("wss://ws3.nextround.tech/upsc-ethics")
    ethicsWsRef.current = ws
    ...
    // console("Language selection prompt received with options:", options)
      ...
      setTimeout(() => {
        ...
        // console(`Automatically sending language selection: ${language}`)
          try {
            ethicsWsRef.current.selectLanguage(language)
  ...
  useEffect(() => {
    ...
    const drawVisualizer = () => {
      ...
      ctx.beginPath()
      ctx.strokeStyle = "#a855f7" // purple color for ethics theme
      ctx.lineWidth = 2
  ...
  const configureAndStartInterview = async () => {
    ...
    try {
      if (!ethicsWsRef.current) return

      await ethicsWsRef.current.configure({ difficulty })
    } catch (error) {
  ...
  const toggleMicrophone = () => {
    if (!ethicsWsRef.current || !interviewState.isRecording) return
  ...
  const resetInterview = () => {
    ...
    if (ethicsWsRef.current) {
      ...
      ethicsWsRef.current = new EthicsWebSocket("wss://ws3.nextround.tech/upsc-ethics")
    }
  }
    ...
    return (
      ...
      >
        <main className="flex-1 flex items-center justify-center p-4 md:p-6">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500">
              Ethics Interview Practice
            </h2>
            ...
            {uiState.setupStep === 1 ? (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                >
                  <h3 className="text-xl font-bold mb-4 text-center text-purple-300">
                    Benefits of Ethics Interview Practice
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Scale className="h-8 w-8 text-purple-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Master ethical frameworks and moral reasoning</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Heart className="h-8 w-8 text-pink-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">
                        Practice in English or Hindi to improve language proficiency
                      </p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Shield className="h-8 w-8 text-violet-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">
                ...
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-purple-300">What to expect:</h2>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Scale className="h-8 w-8 text-purple-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Moral philosophy and ethical theories</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Heart className="h-8 w-8 text-pink-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Ethical dilemmas and case studies</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Shield className="h-8 w-8 text-violet-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Ethics in governance and administration</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 shadow-lg shadow-purple-500/30 transition-all duration-300"
                  >
                    Continue to Setup
                  </motion.button>
                </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-purple-300">Interview Setup</h2>
                  <p className="text-center text-gray-300 mb-4">
                    Configure your Ethics interview settings below. After configuration, you'll be prompted to select
                ...
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-purple-300">Difficulty Level</h2>
                  ...
                  <h2 className="text-xl font-bold mb-4 text-center text-purple-300">Preferred Language</h2>
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 shadow-lg shadow-purple-500/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
        ...
        >
          ...
          <div className="flex-1 p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 overflow-y-auto pb-[40px] md:pb-[40px]">
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center text-2xl md:text-4xl shadow-lg shadow-purple-500/30">
                ET
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-pink-500 to-pink-700 rounded-full flex items-center justify-center shadow-lg shadow-pink-500/30">
          ...
          {(uiState.showChat || uiState.showParticipants) && (
            ...
            >
              <div className="p-4 border-b border-gray-700/50 flex justify-between items-center">
                <h2 className="font-medium text-purple-300">
                    ...
                    {responses
                      ...
                      .map((response, index) => (
                        <motion.div
                          ...
                          className="rounded-xl p-3 bg-purple-500/20 border border-purple-500/30"
                        >
                          <p className="text-sm font-medium mb-1 text-purple-300">Interviewer</p>
                ...
                {uiState.showParticipants && (
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      <div>
                        <p className="font-medium text-purple-300">Ethics Interviewer</p>
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-4"
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-pink-700 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-pink-500/30">
                        <User className="w-6 h-6" />
                      </div>
                      <div>
                        <p className="font-medium text-pink-300">You</p>
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-center mb-6">
                  Thank you for participating in the Ethics practice interview. Your responses have been recorded.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="font-medium text-purple-300">Ethics Interview Tips:</h3>
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <motion.button
                  ...
                  className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 text-white font-medium shadow-lg shadow-purple-500/30 transition-all duration-300"
                >
                  Start New Interview
                </motion.button>
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                {languageOptions.map((option) => (
                  ...
                  >
                    <Globe
                      className={`h-8 w-8 mb-2 ${option.toLowerCase() === animatingLanguage ? "text-purple-400" : "text-gray-500"}`}
                    />
                    ...
                    {option.toLowerCase() === animatingLanguage && (
                      <motion.div
                        ...
                        animate={{ scale: 1 }}
                        transition={{ delay: 0.5 }}
                        className="mt-2 bg-purple-500 rounded-full p-1"
                      >
