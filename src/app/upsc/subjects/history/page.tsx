...
import { HistoryWebSocket } from "@/lib/upsc/subject/history-ws"
...
export default function HistoryInterview() {
  ...
  useEffect(() => {
    const ws = new HistoryWebSocket("wss://ws3.nextround.tech/upsc-history")
    ...
    // console("Language selection prompt received with options:", options)
      ...
      setTimeout(() => {
        ...
        // console(`Automatically sending language selection: ${language}`)
          try {
            historyWsRef.current.selectLanguage(language)
  ...
  useEffect(() => {
    ...
    const drawVisualizer = () => {
      ...
      ctx.beginPath()
      ctx.strokeStyle = "#f59e0b" // amber color for history theme
      ctx.lineWidth = 2
  ...
  const configureAndStartInterview = async () => {
    ...
    try {
      if (!historyWsRef.current) return

      await historyWsRef.current.configure({ difficulty })
    } catch (error) {
  ...
  const toggleMicrophone = () => {
    if (!historyWsRef.current || !interviewState.isRecording) return
  ...
  const resetInterview = () => {
    ...
    if (historyWsRef.current) {
      ...
      historyWsRef.current = new HistoryWebSocket("wss://ws3.nextround.tech/upsc-history")
    }
  }
    ...
    return (
      ...
      >
        <main className="flex-1 flex items-center justify-center p-4 md:p-6">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-orange-500">
              History Interview Practice
            </h2>
            ...
            {uiState.setupStep === 1 ? (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                >
                  <h3 className="text-xl font-bold mb-4 text-center text-amber-300">
                    Benefits of History Interview Practice
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <BookOpen className="h-8 w-8 text-amber-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Master historical concepts and chronological reasoning</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Landmark className="h-8 w-8 text-orange-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">
                        Practice in English or Hindi to improve language proficiency
                      </p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Clock className="h-8 w-8 text-yellow-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">
                ...
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-amber-300">What to expect:</h2>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <BookOpen className="h-8 w-8 text-amber-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Ancient to modern world history</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Landmark className="h-8 w-8 text-orange-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Key historical events and figures</p>
                    </div>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                      <Clock className="h-8 w-8 text-yellow-400 mb-2 mx-auto" />
                      <p className="text-center text-sm">Indian and international history</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 shadow-lg shadow-amber-500/30 transition-all duration-300"
                  >
                    Continue to Setup
                  </motion.button>
                </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-amber-300">Interview Setup</h2>
                  <p className="text-center text-gray-300 mb-4">
                    Configure your History interview settings below. After configuration, you'll be prompted to select
                ...
                <motion.div
                  ...
                  className="bg-gray-900/50 backdrop-blur-md rounded-xl p-4 md:p-6 shadow-lg border border-gray-700/50 mb-6"
                >
                  <h2 className="text-xl font-bold mb-4 text-center text-amber-300">Difficulty Level</h2>
                  ...
                  <h2 className="text-xl font-bold mb-4 text-center text-amber-300">Preferred Language</h2>
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="px-8 py-4 rounded-full font-bold text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 shadow-lg shadow-amber-500/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
        ...
        >
          ...
          <div className="flex-1 p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 overflow-y-auto pb-[40px] md:pb-[40px]">
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-amber-500 to-amber-700 rounded-full flex items-center justify-center text-2xl md:text-4xl shadow-lg shadow-amber-500/30">
                HI
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-orange-500 to-orange-700 rounded-full flex items-center justify-center shadow-lg shadow-orange-500/30">
            ...
            >
              {responses.length > 0 ? (
                ...
                <p className="text-gray-400 italic text-sm md:text-base">
                  Waiting for the history interview to begin...
                </p>
              )}
            </motion.div>
          </motion.div>
              ...
              <div className="flex-1 overflow-y-auto p-4 pb-20 md:pb-4">
                    ...
                    {responses
                      ...
                      .map((response, index) => (
                        <motion.div
                          ...
                          className="rounded-xl p-3 bg-amber-500/20 border border-amber-500/30"
                        >
                          <p className="text-sm font-medium mb-1 text-amber-300">Interviewer</p>
                ...
                {uiState.showParticipants && (
                  <div className="space-y-6">
                    ...
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-amber-700 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-amber-500/30">
                        HI
                      </div>
                      <div>
                        <p className="font-medium text-amber-300">History Interviewer</p>
                    ...
                    <motion.div
                      ...
                      className="flex items-center space-x-4"
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-700 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-orange-500/30">
                        <User className="w-6 h-6" />
                      </div>
                      <div>
                        <p className="font-medium text-orange-300">You</p>
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-gray-300 text-center mb-6">
                  Thank you for participating in the History practice interview. Your responses have been recorded.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="font-medium text-amber-300">History Interview Tips:</h3>
              ...
              <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                ...
                <motion.button
                  ...
                  className="px-6 py-3 rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 text-white font-medium shadow-lg shadow-amber-500/30 transition-all duration-300"
                >
                  Start New Interview
                </motion.button>
              </div>
                ...
                {languageOptions.map((option) => (
                  <motion.div
                    ...
                    className={`p-4 rounded-lg flex flex-col items-center justify-center transition-all duration-200 ${option.toLowerCase() === animatingLanguage
                        ? "bg-amber-500/30 border-2 border-amber-500 text-white scale-110"
                        : "bg-gray-700/50 border border-gray-600 text-gray-400"
                      }`}
                  >
                    <Globe
                      className={`h-8 w-8 mb-2 ${option.toLowerCase() === animatingLanguage ? "text-amber-400" : "text-gray-500"}`}
                    />
                    ...
                    {option.toLowerCase() === animatingLanguage && (
                      <motion.div
                        ...
                        animate={{ scale: 1 }}
                        transition={{ delay: 0.5 }}
                        className="mt-2 bg-amber-500 rounded-full p-1"
                      >
