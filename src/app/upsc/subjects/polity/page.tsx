        ...
        >
          ...
          <div className="flex-1 p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 overflow-y-auto pb-[40px] md:pb-[40px]">
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-red-600 rounded-full flex items-center justify-center text-2xl md:text-4xl">
                PO
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-20 h-20 md:w-32 md:h-32 bg-rose-600 rounded-full flex items-center justify-center text-2xl md:text-4xl">
                ME
              </div>
      ...
      <AnimatePresence>
        {interviewState.interviewComplete && (
          ...
          >
            ...
            >
              <h2 className="text-2xl font-bold text-center mb-4 text-red-300">Interview Complete</h2>
              ...
              <div className="mt-8 flex justify-center gap-4">
                ...
                <motion.button
                  ...
                  className="px-6 py-3 rounded-lg bg-red-600 hover:bg-red-500 text-white font-medium transition-all duration-300"
                >
                  Start New Interview
                </motion.button>
              </div>
