...
export class EthicsWebSocket {
  ...
  public configure(config: EthicsConfig = {}): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        this.ws.onopen = () => {
        // console("WebSocket connected, sending Ethics configuration");
          if (this.ws) {
  ...
  public async startRecording(): Promise<void> {
    ...
    // console("Ethics recording started with correct audio parameters");
    } catch (error) {
  ...
  // console("Ethics recording stopped");
  }
  ...
  // console("Ethics microphone paused - audio transmission stopped");
  }
  ...
  public resumeAudio(): void {
    ...
    this.notifyStatusChange("recording");
  // console("Ethics microphone resumed - audio transmission restarted");
  }
  ...
  public disconnect(): void {
    ...
    this.isConfigured = false;
    this.notifyStatusChange("disconnected");
  // console("Disconnected from Ethics interview, all resources cleaned up");
  }
