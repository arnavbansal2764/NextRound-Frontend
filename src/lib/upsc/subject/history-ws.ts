...
export class HistoryWebSocket {
  ...
  public configure(config: HistoryConfig = {}): Promise<void> {
    return new Promise((resolve, reject) => {
      try {
        ...
        this.ws.onopen = () => {
          console.log("WebSocket connected, sending History configuration");
          if (this.ws) {
  ...
  public async startRecording(): Promise<void> {
    ...
    try {
      ...
      console.log("History recording started with correct audio parameters");
    } catch (error) {
  ...
  public pauseAudio(): void {
    ...
    console.log("History microphone paused - audio transmission stopped");
  }
  ...
  public resumeAudio(): void {
    ...
    this.notifyStatusChange("recording");
    console.log("History microphone resumed - audio transmission restarted");
  }
  ...
  public disconnect(): void {
    ...
    this.isConfigured = false;
    this.notifyStatusChange("disconnected");
    console.log("Disconnected from History interview, all resources cleaned up");
  }
